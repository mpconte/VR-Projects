...
extern GLfloat x[RC_MAX], y[RC_MAX], z[RC_MAX];
extern GLfloat dx[RC_MAX], dy[RC_MAX], dz[RC_MAX];
extern GLfloat hd[RC_MAX], al[RC_MAX], pt[RC_MAX], rl[RC_MAX];
extern GLfloat strips[27][RC_MAX][3], normal[24][RC_MAX][3];
extern int opt[RC_MAX];
extern GLfloat bnormal[2][RC_MAX][3];
extern GLfloat r1[RC_MAX], r2[RC_MAX], r3[RC_MAX];
