...
static VeDeviceFilterInst *headtrack_inst(VeDeviceFilter *f, char **args,
  ...
  VE_DEBUG(1,("ve_htrack: linear loc corr:\n[ %1.4f %1.4f %1.4f %1.4f ]\n"
	      "[ %1.4f %1.4f %1.4f %1.4f ]\n[ %1.4f %1.4f %1.4f %1.4f ]\n"
	      "[ %1.4f %1.4f %1.4f %1.4f ]",
  ...
  VE_DEBUG(1,("ve_htrack: linear dir corr:\n[ %1.4f %1.4f %1.4f %1.4f ]\n"
	      "[ %1.4f %1.4f %1.4f %1.4f ]\n[ %1.4f %1.4f %1.4f %1.4f ]\n"
	      "[ %1.4f %1.4f %1.4f %1.4f ]",
	      priv->linear_loc_corr.data[0][0],
	      priv->linear_loc_corr.data[0][1],
...
static int headtrack_proc(VeDeviceEvent *orig, void *arg) {
  ...
  case HT_POSQUAT:
    ...
    VE_DEBUG(2,("eye.dir = [%1.4f %1.4f %1.4f] - eye.up = [%1.4f %1.4f %1.4f]",
  ...
  case HT_QUAT:
    ...
    for(i = 0; i < 4; i++)
      q.data[i] = v->value[i];
    VE_DEBUG(2,("quat is: (%g,%g,%g,%g)",q.data[0],q.data[1],q.data[2],q.data[3]));
    orient_from_quat(eye,priv,&q);
    VE_DEBUG(2,("eye.dir = [%1.4f %1.4f %1.4f] - eye.up = [%1.4f %1.4f %1.4f]",
		f.dir.data[0],f.dir.data[1],f.dir.data[2],
		f.up.data[0],f.up.data[1],f.up.data[2]));
