/* The Linux-specific component of the Audio library.  Uses the
   SGI audiofile library for reading files
   and basic Linux audio calls for the rest.  This should be portable
   with a small amount of work to other machines which use the OSS
   interface.
*/
#include <assert.h>
#include <stdio.h>
